...
export default function Example() {
  ...
  return (
    <div className="min-h-screen bg-black pt-12">
      <div
        className="max-w-md px-4 mx-auto sm:px-7 md:max-w-4xl md:px-6 p-5 rounded-lg"
        style={{
          maxWidth: "1000px",
          width: "100%",
      ...
      >
        <div className="flex flex-col md:flex-row md:divide-x md:divide-gray-200">
          <section
            className="mt-12 md:mt-0 md:mr-3 "
            style={{
              maxWidth: "250px",
              width: "100%",
              backgroundColor: "#1C1C1C",
                ...
                >
                  ...
                  <div className="w-1 h-1 mx-auto mt-1">
                    {meetings.some((meeting) =>
                      ...
                      <div className="w-1 h-1 rounded-full bg-sky-900"></div>
                    )}
                  </div>
                </div>
              ))}
          ...
          <section className="mt-12 md:mt-0 md:pl-5 ">
...
//         as="div"
//         className={
//           "relative opacity-0 focus-within:opacity-100 group-hover:opacity-100"
//         }
//       >
//         <div>
