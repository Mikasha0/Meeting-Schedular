...
export default function MultipleGuestsInput({ inputFields,addInputField}: any) {
  return (
    <>
              ...
              <div className="flex items-center">
                <div className="relative flex items-center">
                  <input
                    ...
                    placeholder="E-mail"
                  />
                  <button className="absolute top-6 right-2 transform -translate-y-1/2 text-gray-500 focus:outline-none">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      viewBox="0 0 24 24"
