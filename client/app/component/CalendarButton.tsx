...
export default function CalendarButton({isEqual, isToday, day, selectedDay, setSelectedDay, firstDayCurrentMonth, isSameMonth, isSaturday, isSunday, format, classNames}:any) {
  return (
    <button
      type="button"
      onClick={() => {
      ...
      className={classNames(
        ...
        !isEqual(day, selectedDay) &&
          ...
          !isSameMonth(day, firstDayCurrentMonth) &&
          "text-gray-900",
        isEqual(day, selectedDay) && isToday(day) && "bg-black text-black",
